# Example:
# LabelType.create(name: "Plate", feed_value: "004", 
# fine_adjustment: "08", pitch_length: "0110", 
...
class LabelType < ActiveRecord::Base
  ...
  validates :pitch_length, :print_width, :print_length, presence: true, 
            format: { with: /\A\d{4}\z/ }
  ...
  ##
  # When a print job is execute the data input is made of 
  # labels and standard commands.
  # This includes things such as pitch length which are used 
  # for certain commands.
  # These need to be derived from the label type and fed 
  # into the print job.
