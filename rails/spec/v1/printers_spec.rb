...
RSpec.describe V1::PrintersController, type: :request do |variable|
  ...
  it "should allow creation of a new printer" do
    expect {
      post v1_printers_path, {data:{type: :printer, attributes:attributes_for(:printer)}}.to_json, 'ACCEPT' => "application/vnd.api+json", 'CONTENT_TYPE' => "application/vnd.api+json" 
  ...
  it "should prevent creation of a new printer with invalid attributes" do
     expect {
      post v1_printers_path, {data:{type: :printer, attributes:{name:nil}}}.to_json, 'ACCEPT' => "application/vnd.api+json", 'CONTENT_TYPE' => "application/vnd.api+json" 
