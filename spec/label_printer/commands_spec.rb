...
RSpec.describe LabelPrinter::Commands, type: :model do
  ...
  context 'Format Bitmap' do
    ...
    let(:command_with_options) do
      LabelPrinter::Commands::BitmapFormat.new(id: '001', x_origin: '0020', y_origin: '0035',
  ...
  context 'Format Barcode' do
    ...
    context '1D' do
      let(:command) do
        LabelPrinter::Commands::BarcodeFormat.new(id: '001', x_origin: '0300', y_origin: '0000',
